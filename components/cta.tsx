                ...
                <div className="space-y-8">
                  ...
                  <div className="text-center">
                    <a
                      ...
                      className="group relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 hover:from-blue-700 hover:via-purple-700 hover:to-blue-700 text-white px-12 py-6 text-xl font-semibold rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-blue-500/25 inline-flex items-center gap-3"
                    >
                  ...
                  <div className="relative">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-white/5 border-white/20 text-white hover:bg-white/10 hover:border-white/30 py-4 rounded-xl backdrop-blur-sm transition-all hover:scale-105 inline-flex items-center gap-3 px-6"
                      >
