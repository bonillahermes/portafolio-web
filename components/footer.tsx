        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              Analítica de datos, inteligencia artificial y sistemas para el sector público colombiano.
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-white border border-border text-muted-foreground hover:text-accent hover:border-accent/40 transition-colors"
                aria-label="LinkedIn"
              >
          ...
          {/* Navigation */}
          <div>
            <p className="text-xs font-semibold text-foreground uppercase tracking-wider mb-5">
              Navegación
            </p>
