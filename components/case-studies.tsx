                    ...
                    {currentCase.metrics.map((metric, index) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="text-sm font-semibold text-slate-700">{metric.indicator}</h4>
                          <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                            metric.impact.startsWith('+') ? 'bg-green-100 text-green-700' : 
                            metric.impact.startsWith('-') ? 'bg-blue-100 text-blue-700' : 
                        ...
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                            ...
                            <div className="text-sm font-medium text-slate-600">{metric.before}</div>
                          </div>
                          <div>
                            <div className="text-xs text-slate-500 mb-1">DESPUÉS</div>
                            <div className="text-lg font-bold text-blue-600">{metric.after}</div>
                          </div>
                          <div>
                            <div className="text-xs text-slate-500 mb-1">IMPACTO</div>
                            <div className="text-sm font-semibold text-green-600">{metric.impact}</div>
                          </div>
                        </div>
                      </div>
                    ))}
